...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="tambah_menu.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Tambah Menu Makan</span>
          </a>
        </li>
      </ul>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container animated">
        ...
        <div class="row mt-4">
            <div class="col-lg-6">
                <form id="edit-menu-form" action="editmenu.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
    
                    <div class="form-group">
                        <label for="nama_makanan">Nama Makanan/Minuman:</label>
                        <input type="text" class="form-control" name="nama_makanan" required value="<?php echo $row['nama_makanan']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="file_path">Gambar Lama:</label>
                        <img src="<?php echo $row['file_path']; ?>" alt="Gambar Lama" width="150">
                    </div>

                    <div class="form-group">
                        <label for="new_file_path">Pilih Gambar Baru (Opsional):</label>
                        <input type="file" class="form-control" name="new_file_path" accept="image/*">
                    </div>
